...
typedef enum
{
	INPUT_TYPE_NOTHING = 0, INPUT_TYPE_LEFT, INPUT_TYPE_RIGHT, INPUT_TYPE_UP, INPUT_TYPE_DOWN, INPUT_TYPE_START, INPUT_TYPE_UP_LEFT, INPUT_TYPE_UP_RIGHT, INPUT_TYPE_DOWN_LEFT, INPUT_TYPE_DOWN_RIGHT, INPUT_TYPE_COUNT
}input_type;
